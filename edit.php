...
<body>
    ...
    <section class="edit_container">
        ...
        <form action="" class="update_product product_container_box" method="post" enctype="multipart/form-data">
            <img src="img/<?php echo $fetch_data['image']?>" alt="">
            ...
            <div class="btns">
                <input type="submit" class="edit_btn" value="Edit product"
                name="update_product">
                <input type="reset" id="close-edit" class="cancel_btn" value="Cancle">
            </div>
        </form>
